...
object DegreesOfSeparation {
  ...
  def bfsReduce(data1: BFSData, data2: BFSData): BFSData = {
    ...
    //    println(s"color is ${color} [first time branch] ")
    //    OR process it with string comparison
    //    if (color1 >= color2) {
    //      color = color2
    //    } else {
    //      color = color1
    //    }
    //    OR process it with ascii code comparison
    //    if (color1.charAt(0).toInt >= color2.charAt(0).toInt) {
    //      color = color2
    //    } else {
    //      color = color1
    //    }
    //    println(s"color is ${color} [second time branch] ")
